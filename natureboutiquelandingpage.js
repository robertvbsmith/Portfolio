//start by creating a function to initialize all of the code for our slider called 'init'

let init = () => {
    // the first container class is the one we will be using for our slider, so make sure to default to [0]
    let container = document.getElementsByClassName('jumbo-slider__container')[0],
    //lets find all of the slides by class using the code written below
    slides = document.getElementsByClassName('jumbo-slider__slide'),
    //lets find all of the circles by class using the code written below
    circles = document.getElementsByClassName('jumbo-slider__circle'),
    //lets find all of the links by class using the code written below
